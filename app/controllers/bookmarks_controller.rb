class BookmarksController < ApplicationController
  def index
    ...
    @bookmarks = @q.result(:distinct => true).includes(:guest, :listing).page(params[:page]).per(10)
  ...
  def create
    ...
    @bookmark.bookmark_title = params[:bookmark_title]
    @bookmark.guest_id = params[:guest_id]
